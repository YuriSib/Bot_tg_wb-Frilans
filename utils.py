...
async def get_basket(vol):
    baskets = {
        ...
        'basket-14.wb.ru/': [x for x in range(2046, 2189 + 1)],
        'basket-15.wb.ru/': [x for x in range(2191, 2405 + 1)],
        'basket-16.wb.ru/': [x for x in range(2407, 2620 + 1)],
        'basket-17.wb.ru/': [x for x in range(2622, 2836 + 1)],
        'basket-18.wb.ru/': [x for x in range(2838, 3052 + 1)],
        'basket-19.wb.ru/': [x for x in range(3054, 3268 + 1)],
        'basket-20.wb.ru/': [x for x in range(3270, 3484 + 1)],
        'basket-21.wb.ru/': [x for x in range(3486, 3700 + 1)],
        'basket-22.wb.ru/': [x for x in range(3702, 3916 + 1)],
        'basket-23.wb.ru/': [x for x in range(3918, 4132 + 1)],
        'basket-24.wb.ru/': [x for x in range(4134, 4348 + 1)],
        'basket-25.wb.ru/': [x for x in range(4350, 4564 + 1)],
        'basket-26.wb.ru/': [x for x in range(4566, 4876 + 1)],
        'basket-27.wb.ru/': [x for x in range(4878, 5188 + 1)],
